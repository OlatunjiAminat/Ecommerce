...
function SecondSectionA() {
  return (
    <Link href="/headphones/headphoneDetails2">
      <div className='mx-auto max-w-[300px] text-center lg:max-w-[450px]'>
          ...
          <div className='bg-deep-white mt-[-50px] mx-3 pt-16 pb-5 px-12 md:px-16 lg:px-20 text-center text-sm rounded'>
              ...
              <div className='text-xs pt-3'>
                <Link href="/headphones/headphoneDetails2" className='text-gray-600 hover:text-deep-brown'>SHOP <span className='ml-3 text-deep-brown font-extrabold text-sm'>&#62;</span></Link>
              </div>
          </div>
      </div>
    </Link>
