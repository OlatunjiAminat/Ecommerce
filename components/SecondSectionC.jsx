...
function SecondSectionC() {
  return (
    <Link href="/earphones/earphoneDetail">
      <div className='mx-auto max-w-[300px] text-center lg:max-w-[350px]'>
            ...
            <div className='bg-deep-white mt-[-40px] mx-4 pt-16 pb-5 px-12 md:px-16 lg:px-20  text-center text-sm rounded'>
                ...
                <div className='text-xs pt-3'>
                  <Link href="/earphones/earphoneDetail" className='text-gray-600 hover:text-deep-brown'>SHOP <span className='ml-3 text-deep-brown font-extrabold text-sm'>&#62;</span></Link>
                </div>
            </div>
      </div>
    </Link> 
