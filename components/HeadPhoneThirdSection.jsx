...
function HeadPhoneThirdSection() {
  return (
    <div className='lg:flex justify-center items-center lg:mt-16 lg:mx-20 xl:mx-[190px] '>
        <div className='bg-deep-white flex justify-center items-center mt-7 md:mt-10 md:max-w-[450px] py-5 mx-10 rounded-lg lg:px-32 lg:py-20 mx-auto max-w-[300px] lg:order-2 xl:ml-[130px]'>
            <Image src="/smallHeadset.png" alt="headset" width={150} height={5} loading="lazy" className='lg:w-[500px]'  />
        </div>
        <div className='lg:ml-6'>
            <div className='mt-8'>
                <h2 className='font-thin my-2 text-xl pb-3 text-center lg:text-start text-deep-black'>XX99 MARK I <br/> HEADPHONES</h2>
            </div>
...
export default HeadPhoneThirdSection